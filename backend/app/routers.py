...
def create_app():
    ...
    # app.include_router(article_router, prefix='/api/stock', tags=['股票模块'])
    # app.include_router(article_router, prefix='/api/option', tags=['期权模块'])
    # app.include_router(article_router, prefix='/api/digital_currency', tags=['数字货币模块'])
