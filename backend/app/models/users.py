...
if __name__ == '__main__':
    ...
    # 添加用户
    add_visit_user = User(username='visitor', password='123123', roles='visit',
                          email='3213145dsa@qq.com',
                          introduction='I am a visitor',
                          avatar='https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif')
    add_editor_user = User(username='editor', password='123123',
                           email='982020991@qq.com', roles='editor',
                           introduction='I am an editor',
                           avatar='https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif')
    add_admin_user = User(username='administrator', password='123123',
                          email='215198532@qq.com', roles='admin',
                          introduction='I am a admin',
                          avatar='https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif')
    add_super_admin_user = User(username='super_administrator', password='123123', roles='super_admin',
