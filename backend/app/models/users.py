...
class User(Base):
    ...
    def __init__(self, username, password, roles, introduction, avatar):
...
if __name__ == '__main__':
    ...
    # 添加用户
    # add_editor_user = User(username='aaa', password='123123', roles=['editor'],
    #                        introduction='I am an editor',
    #                        avatar='https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif')
    # add_admin_user = User(username='bbb', password='123123', roles=['admin'],
    #                       introduction='I am a admin',
    #                       avatar='https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif')
    # add_super_admin_user = User(username='ccc', password='123123', roles=['super_admin'],
